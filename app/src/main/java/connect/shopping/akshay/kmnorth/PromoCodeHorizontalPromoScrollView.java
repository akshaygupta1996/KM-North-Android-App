...
public class PromoCodeHorizontalPromoScrollView extends HorizontalScrollView {
    Context context;
    int prevIndex = 0;

    public PromoCodeHorizontalPromoScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setAdapter(Context context, PromoCodeAtCheckoutAdaptor mAdapter) {
    ...
    private void fillViewWithAdapter(PromoCodeAtCheckoutAdaptor mAdapter)
