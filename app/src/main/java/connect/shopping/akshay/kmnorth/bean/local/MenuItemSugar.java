...
public class MenuItemSugar extends SugarRecord {
    ...
    public MenuItemSugar() {
    }

    public MenuItemSugar(int cat_id, boolean choice, String choice_one, String choice_two, String description, int full_price, int half_price, String name, int uniqueId) {
        this.cat_id = cat_id;
        this.choice = choice;
